...
String no_kel,nama_kel,select,flag=null;
...
flag = request.getParameter("n");
  ...
  record1=(UserInfo1)session.getAttribute("remoteRef");
     ...
     factory=ServiceController.getInstance();
      ...
      remote = home.create();
   //   no_prop = remote.getNoProp();

        record=(UserInfo)remote.compare_KKID(s3);
        record2 = (UserInfo2)remote.compare_KKID1(s3);
        out.println("Record2= " + record2);
...
<input type="hidden" name="newkk" value="<%=record2.getNoKk().trim()%>">
...
<input type=hidden name='noakwn' value="0">
 ...
 <select name="stat_hbkel" boxdefault2 class="boxdefault">
                  <option value="0">-- Pilih Status Hub. dalam Keluarga--</option>
				      <option value="2">1 - Suami</option>
				      <option value="3">2 - Istri</option>
				      <option value="4">3 - Anak</option>
				      <option value="5">4 - Menantu</option>
				      <option value="6">5 - Cucu</option>
				      <option value="7">6 - OrangTua</option>
				      <option value="8">7 - Mertua</option>
				      <option value="9">8 - Famili Lain</option>
				      <option value="10">9 - Pembantu</option>
				      <option value="11">10 - Lainnya</option>
				    </select>
