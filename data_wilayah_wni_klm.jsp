...
<table width="200" border="0" cellspacing="3" cellpadding="2" align="center">
  <tr>
    <td colspan="5" height="25">
      <div align="center"><span class="subtitle">Menu Pendaftaran Penduduk WNI</span></div>
    </td>
  </tr>
  <tr>
    <td colspan="5" height="10"><img src="images/dot.gif" width="1" height="1">
    </td>
  </tr>
  <%
                       if (level>0) {%>
  <tr>
    ...
    <td rowspan="5"><img src="images/dot.gif" width="1" height="1"> &nbsp;
      </td>
  </tr>
  <%} if (level>2) {%>
  <tr>
