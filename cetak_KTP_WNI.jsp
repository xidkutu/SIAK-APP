...
<SCRIPT language=JavaScript src="scripts/cetakktpwni.js">
</SCRIPT>
...
window2=openIT('adv_list.jsp?r=h&type=2',310,140,580,475,'window2',5,false,false,false);
}
</SCRIPT>
...
%>
                                                ...
                                                <tr>
                                                   <td class="C-Field" width="3%">
                                                      <div align="center"><input type=checkbox name="cb" value="<%=wniObject.getNik()%>" onclick="unchecked(1);"></div>
                                                   </td>
                                                   ...
                                                   <td class="C-Field" width="8%">
                                                      <div align="center"><input class=boxstandard type=file name="uploadfile" onchange="LimitAttach(this.form, this.form.uploadfile.value,this.form.imgfoto)" onkeydown="this.blur()"></div>
                                                   </td>
                                                   <td class="C-Field" width="15%">
