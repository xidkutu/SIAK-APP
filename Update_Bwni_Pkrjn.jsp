...
String [] data = {"nik","jenis_pkrjn_lama","jenis_pkrjn","sk_no","sk_tgl_dd","sk_tgl_mm","sk_tgl_yyyy","sk_ins","sk_ttd","nama_pet_reg","nip_pet_reg"};
...
if (session.getAttribute("remoteRef")!=null)
{
   ...
   String inp_elm="";
System.out.println("=================================");
System.out.println("========insert pekerjaan========");
System.out.println("=================================");
  ...
  if(home != null)
      {
	   ...
	   remoteWNIBiodata.insert_pkrjn(v);
	   b = true;
