...
<%
      ...
      {
%>
<form name="form1" method="post" action="KematianInput.jsp">
...
<%=printInfo("Data Sudah disimpan !")%></font>
...
{
ne.printStackTrace();
  System.out.println("Exception in Show Mati = " + ne);
}
