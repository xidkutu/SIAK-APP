...
<%!
   String noaktakwn,nama_suami,nama_istri;
   int i,j,k,l,z;
%>
...
if (session.getAttribute("remoteRef")!=null)
{
   ...
   noaktakwn=request.getParameter("noaktakwn");

   nama_suami=request.getParameter("nama_suami");
   nama_istri=request.getParameter("nama_istri");
System.out.println("nama_suami di show kawin= "+nama_suami);
System.out.println("nama_istri di show kawin= "+nama_istri);
        ...
        <table border="0" cellspacing="3" cellpadding="2" align="center">
          ...
          <tr>
           <td colspan="3" height="25">
              ...
              <div align="center"><span class="subtitle">Pencatatan Kawin</span></div>
                            </td>
          </tr>
          <tr>
            <td colspan="3" height="1">
              ...
              <td class="C-BG">
                <table border="0" cellspacing="1" cellpadding="3" align="center">
                  <tr>
                    ...
                    <td class="C-Fonts">
                      <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" class="C-Fonts">No Akta Kawin</font></div>
                    </td>
                    <td class="C-Fonts">
