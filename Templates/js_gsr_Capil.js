...
//			Teks listMenu			#F9FAA7
  ...
  ajmenu1.addItems('<font face="Verdana", size="1">PENCATATAN KELAHIRAN</font>', 'Pencatatan_Kabupaten_Edit.jsp');
  ajmenu1.addItems('<font face="Verdana", size="1">PENCATATAN KEMATIAN</font>', 'Pencatatan_Kematian_Edit.jsp');
  ajmenu1.addItems('<font face="Verdana", size="1">PENCATATAN PERKAWINAN</font>', 'Kawin.jsp');
  ajmenu1.addItems('<font face="Verdana", size="1">PENCATATAN PERCERAIAN</font>', 'Perceraian_List.jsp');
