<%@ page language="java" import="java.util.*,pendaftaran.*,keluargawna.*"%>

<%!

    String nama_prop,nama_kab,nama_kec,nama_kel,nama_kep,alamat;
    String telp,dusun,no_prop,no_kab,no_kec,no_kel,ned,niped,dd;
...
<%
   ...
   no_rt = Integer.parseInt(((request.getParameter("no_rt")==null || request.getParameter("no_rt").trim().equals(""))?"0":request.getParameter("no_rt")));
   no_rw= Integer.parseInt(((request.getParameter("no_rw")==null || request.getParameter("no_rw").trim().equals(""))?"0":request.getParameter("no_rw")));
   dusun = request.getParameter("dusun");
   kodepos = Integer.parseInt(((request.getParameter("kodepos")==null || request.getParameter("kodepos").trim().equals(""))?"0":request.getParameter("kodepos")));
              ...
              <tr>
                <td>
                  <table width="100%" border="0" cellspacing="3" cellpadding="3">
                    ...
                    <tr>
                        <td>
                           <% String jsp = "data_wilayah_2.jsp?level=2&no_prop=" + (request.getParameter("no_prop")==null?"":request.getParameter("no_prop")) + "&nama_prop=" + (request.getParameter("nama_prop")==null?"":request.getParameter("nama_prop")) +
                                           "&no_kab=" + (request.getParameter("no_kab")==null?"":request.getParameter("no_kab")) + "&nama_kab=" + (request.getParameter("nama_kab")==null?"":request.getParameter("nama_kab"));%>
                    ...
                    <tr>
                      <td valign="top">
                        <table width="600" border="0" cellspacing="3" cellpadding="2" align="center">
                          ...
                          <tr>
                              <td valign="top" width="188"> Nomor Kartu Keluarga<br>
                              <span class="linkyellow">(Family Card Number)</span>
                            </td>
                              <td valign="top" width="12">:</td>
                              <td valign="top" width="328"> <b>&lt;Create By System&gt;
                                </b> </td>
                              <td valign="top" width="41"><b><Create By System> </b></td>
                          </tr>
                          <tr>
                              <td valign="top" width="188"> Nama Kepala Keluarga<br>
                              <span class="linkyellow">(Head of Family Name)</span></td>
                              <td valign="top" width="12">:</td>
                            <td valign="top" colspan="2"><b><%=nama_kep.toString().toUpperCase()%></b></td>
                          </tr>
                          <tr>
                              <td valign="top" width="188"> Alamat Keluarga <span class="linkyellow"><br>
...
<input  class=boxdefault size=22 name=nama_klrga maxlength="55" onKeyUp="return kepa()">
                                ...
                                <%=nama_kep.toString().toUpperCase()%>
<input type="hidden" value="<%=nama_kep.toString().toUpperCase()%>" name=nama_pertma>
                                    </b></td>
                                  <td width="12">&nbsp;</td>
...
<select class="boxdefault" name="jenis_klmin">
                                ...
                                <tr>
                                  ...
                                  <td valign="top">:</td>
                                  <td colspan="2" valign="top"> <b>
 <input class=boxdefault size=22 name=tmpt_lhr maxlength="20" onKeyUp="return temlhr()">
                                    </b></td>
                                  <td width="12">&nbsp;</td>
...
<input class=boxdefault size=22 name=datng_dari maxlength="20" onKeyUp="return dadar()">
                                        ...
                                        <td width="29%"> <b>
<input class=boxdefault size=22 name=tujuan_dtng maxlength="40" onKeyUp="return tuj()">
                                          </b></td>
                                      </tr>
                                      <tr valign="top">
...
{
%>
<input type=hidden name="a<%=m%>" value=<%=v.elementAt(m)%>>
<%
}
%>
                                        <td width="22%"><font face="Verdana" size="2">
...
<input class=boxdefault size=4 name=tl3 maxlength="4" onKeyUp="return checkYY(tl1,tl2,tl3,'N')">
                                      ...
                                      <tr valign="top">
                                        ...
                                        <td width="22%"><font face="Verdana" size="2">
                                          <b>
 <input class=boxdefault size=22 name=tmpt_dtng_pert maxlength="30" onKeyUp="return tdper()">
                                          </b></font></td>
                                        <td width="2%">&nbsp;</td>
                                ...
                                <tr valign="top">
                                  <td>
                                    <table border="0" cellspacing="3" cellpadding="3" width="100%">
                                      <tr>
                                        <td>
<span lang="EN-GB" style="mso-bidi-font-size: 12.0pt; mso-fareast-font-family: Times New Roman; mso-bidi-font-family: Times New Roman; mso-ansi-language: EN-GB; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">
 Nama Sponsor<font color="#000099" class="asterish">
 *</font><br>
<span class="linkyellow">(Sponsor Name)</span></span>
</td>
<td>:</td>
<td><b>
<input class=boxdefault size=22 name=nama_spsor maxlength="55" onKeyUp="return namspr()">
                                          </b></td>
                                        <td>&nbsp;</td>
...
<select class="boxdefault" name="tipe_spsor">
                                      ...
                                      <tr>
                                        <td>Alamat&nbsp;Sponsor<font class="asterish">
                                          </font><br>
...
<input type="hidden"  name=nip_din VALUE="<%=record.getKabNipPej()%>">
                                        ...
                                        <td>:</td>
<td><b><font color="#000066"><%=ned%></font></b> </td>
                                      </tr>
                                      <tr>
                                        <td>NIP Petugas Entri Data<font color="#000099" class="asterish">
                                          *</font></td>
                                        <td>:</td>
<td><b> <font color="#000066"><%=niped%></font></b></td>
                                        <td>&nbsp;</td>
...
<input type = hidden name=ned value="<%=ned%>">
   ...
   <input class=boxstandard disabled type=button value=SIMPAN name="simbtn" onclick="return ValiBio()">
                          </b></div>
                      </td>
                      <td>
                        <div align="center"><b>
