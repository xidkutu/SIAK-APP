...
function printLaporan(obj)
{
     if (window.print)
     {
         if (confirm("Apakah benar Jumlah Penduduk Menurut Struktur Umur,Jenis Kelamin dan Kepemilikan Akta Kelahiran(P4B) ini akan dicetak ?"))
          {
...
remote = home.create();
 b=remote.getTotJumlahp4b(nprop,nkab,nkec,nkel,thu);
                    ...
                    <tr>
                      <td height="25">
                        <div align="center"><span ><b>Jumlah Penduduk Menurut
                          Struktur Umur,<br>
                          Jenis Kelamin dan Kepemilikan Akta Kelahiran(P4B)</b></span></div>
                      </td>
                    </tr>
                    <tr>
                      <td height="1">
