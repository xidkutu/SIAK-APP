<%@ page import="java.sql.*,java.util.*,javax.rmi.*,javax.naming.*,javax.ejb.*,pendaftaran.*"%>
<%@include file="Global.jsp"%>
<%!
 String nik_bayi,nama_bayi;
 int i,j,k,l,z;
%>
...
<%
   try
   {
   nik_bayi=request.getParameter("nikbayi");

   nama_bayi=(String)session.getAttribute("nama_bayi");
...
%>
                    ...
                    <td align="center" class="C-Field">
<script language="JavaScript">
document.write(""+tgl_entri.getDate()+"-"+(tgl_entri.getMonth()+1)+"-"+tgl_entri.getYear())
</script>
</td>
...
{
ne.printStackTrace();
  System.out.println("Exception in Show Lahir = " + ne);
 response.sendRedirect("index.jsp");
}
%>
