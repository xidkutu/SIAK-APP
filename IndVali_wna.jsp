...
<%
String no_kk="",no_prop="",no_kab="",no_kec="",no_kel="";
ServiceController factory=null;
Vector get_ala=null,v=null;
String stathub="",dd="",niped="",ned="";
GetNokkHome home=null;
GetNokk remote=null;
NOKKHome home1=null;
NOKK remote1=null;
int i=0,j=0,k=0;
...
if(record != null)
   ...
   home = (GetNokkHome) factory.lookup("GetNokk",GetNokkHome.class);

   remote = home.create();
   get_ala = remote.GnokkNew(no_kk,no_prop,no_kab,no_kec,no_kel);
   j=get_ala.size();

 if(get_ala.isEmpty())
{
%>
       <jsp:forward page="Indivi_wna.jsp">
       <jsp:param name="error" value="9"/>
...
{
      home1 = (NOKKHome) factory.lookup("NOKK", NOKKHome.class);
      remote1 = home1.create();
      v=new Vector();
      v = remote1.verifyNikNew(no_kk,no_prop,no_kab,no_kec,no_kel);
      stathub=remote1.verifyKKNew(no_kk,no_prop,no_kab,no_kec,no_kel);
      k=v.size();
%>
...
function winlist()
{
	...
	window.open("Popup_Wni.jsp?no_kk=<%=no_kk%>","my_new_window","toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width=900,height=300")
}
</script>
                      ...
                      <td valign="top">
                        <table width="600" border="0" cellspacing="3" cellpadding="2" align="center">
                          ...
                          <tr>
                              ...
                              <td valign="top" width="187"> <b><%=get_ala.elementAt(0) %></b> </td>
                              <td valign="top" width="161"><b> </b></td>
                          </tr>
                          <tr>
                              <td valign="top" width="181"> Nama Kepala Keluarga<br>
                              <span class="linkyellow">(Head of Family Name)</span></td>
                              <td valign="top" width="40">:</td>
                            <td valign="top" colspan="2"><b><%=get_ala.elementAt(1).toString().toUpperCase()%></b></td>
                          </tr>
                          <tr>
                              <td valign="top" width="181"> Alamat Keluarga <span class="linkyellow"><br>
                              (Family Address)</span></td>
                              <td valign="top" width="40">:</td>
                            <td valign="top" colspan="2"><b><%=get_ala.elementAt(2).toString().toUpperCase()%></b></td>
                          </tr>
                          <tr>
                              <td valign="top" width="181">&nbsp;</td>
                              <td valign="top" width="40">&nbsp;</td>
                        <td valign="top" colspan="2"><div align="right"><i><b><a href="javascript:winlist()">
<font face="Verdana">Tampilkan
                                    ...
                                    <table width="100%" border="0" cellspacing="5" cellpadding="5">
                                      <tr valign="top">
                                        ...
                                        <td width="22%"><font face="Verdana" size="2">
                                          <b>
<input class=boxdefault size=22 name=datng_dari maxlength="60" onKeyUp="return dadar()">
                                          </b></font></td>
                                        <td width="2%">&nbsp;</td>
...
<select class="boxdefault" name="dok_imgr">
                                      ...
                                      <tr valign="top">
                                        ...
                                        <td width="22%"><font face="Verdana" size="2">
                                          <b>
<input class=boxdefault size=22 name=num_dok maxlength="40" onKeyUp="return numdoc()">
                                          </b></font></td>
                                        <td width="2%">&nbsp;</td>
...
<input type = hidden name=nok value="<%=no_kk%>">
<input type = hidden name=nama_kep value="<%=get_ala.elementAt(1)%>">
<input type = hidden name=alamat value="<%=get_ala.elementAt(2)%>">
