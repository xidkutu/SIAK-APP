...
public class Wni_NumpangBean implements SessionBean {
  ...
  public void ejbCreate() throws CreateException
  {
    try
    {
      ...
      siakWriter = new SiakWriter(path, "Wni_NumpangBean.class");
    }
    catch(Exception e)
    {
      e.printStackTrace();
  ...
  public boolean nump_insert(java.util.Vector v)
  {
    ...
    boolean flag;
    System.out.println("size of the vector insert " +v.size());
try
    {
