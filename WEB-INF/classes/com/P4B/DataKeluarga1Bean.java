...
abstract public class DataKeluarga1Bean implements EntityBean {
  ...
  BiodataWni1 bioremote=null;
  BiodataWni1Home biohome=null;
  ...
  public java.lang.String ejbCreateKK(P4BBioObject form) throws CreateException  {
    /**@todo Complete this method*/
     setNoKk(form.getNoKk());
     setNamaKep(form.getNama_kep());
     setAlamat(form.getAlamat());
     setNoRt(form.getNoRt());
     setNoRw(form.getNoRw());
     setDusun(form.getDusun());
     setKodePos(form.getKodePos());
     setTelp(form.getTelp());
     setNoProp(form.getNo_prop());
     setNoKab(form.getNo_kab());
     setNoKec(form.getNo_kec());
     setNoKel(form.getNo_kel());
     setTglInsertion(form.getTglEntri());
     setPflag("N");
     setCflag("N");
    return null;
  }
 ...
 public void ejbPostCreateKK(P4BBioObject form) throws CreateException  {

     try{
           entity=ServiceEntity.getInstance();
           biohome=(BiodataWni1Home)entity.lookup("SiakBiodataWni1",BiodataWni1Home.class);
           bioremote=biohome.createBio(form);
        }catch(Exception err)
        {
