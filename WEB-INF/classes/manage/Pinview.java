/* compiled from JSP: /Pin_Pengguna_User.jsp
*
* This code was automatically generated at 6:30:06 PM on May 4, 2004
...
// User imports
import javax.naming.*; //[ /Pin_Pengguna_User.jsp; Line: 6]
import javax.rmi.*; //[ /Pin_Pengguna_User.jsp; Line: 6]
import java.util.*; //[ /Pin_Pengguna_User.jsp; Line: 6]
import pendaftaran.*; //[ /Pin_Pengguna_User.jsp; Line: 6]
...
implements weblogic.servlet.jsp.StaleIndicator
{
    ...
    //[ /Global.jsp; Line: 333]
    //[ /Pin_Pengguna_User.jsp; Line: 9]
    String select,id1=null,flag=null; //[ /Pin_Pengguna_User.jsp; Line: 10]
    Vector v = null; //[ /Pin_Pengguna_User.jsp; Line: 11]
    UserInfo1 record=null; //[ /Pin_Pengguna_User.jsp; Line: 12]
    //[ /Pin_Pengguna_User.jsp; Line: 13]
...
//        javax.servlet.ServletContext application = config.getServletContext();
        ...
        try { // error page try block
            ...
            response.setHeader("Pragma", "No-cache"); //[ /Pin_Pengguna_User.jsp; Line: 1]
            response.setDateHeader("Expires", 0); //[ /Pin_Pengguna_User.jsp; Line: 2]
            response.setHeader("Cache-Control", "no-cache"); //[ /Pin_Pengguna_User.jsp; Line: 3]
            response.setHeader("Cache-Control", "private"); //[ /Pin_Pengguna_User.jsp; Line: 4]
            out.print("\r\n");
            out.print("\r\n");
            //INCLUDE /Global.jsp //[ /Pin_Pengguna_User.jsp; Line: 7]
            out.print("\r\n");
            out.print("\r\n");
            out.print("\r\n");
            out.print("\r\n");
            ...
            out.print("\r\n\r\n");
            out.print("\r\n\r\n");
            //[ /Pin_Pengguna_User.jsp; Line: 15]
            record=(UserInfo1)session.getAttribute("remoteRef"); //[ /Pin_Pengguna_User.jsp; Line: 16]
            //[ /Pin_Pengguna_User.jsp; Line: 17]
            if(record != null) //[ /Pin_Pengguna_User.jsp; Line: 18]
            { //[ /Pin_Pengguna_User.jsp; Line: 19]
                ...
                out.print("                    <table width=\"125\" border=\"0\" cellspacing=\"2\" cellpadding=\"2\">\r\n                                      <tr>\r\n                                        <td class=\"boxdefault\">\r\n                                          <div align=\"left\" class=\"boxdefault2\">");
                out.print(String.valueOf((String)session.getAttribute("pin")));  //[ /Pin_Pengguna_User.jsp; Line: 129]
//                out.print("</div>\r\n                                        </td>\r\n                                      </tr>\r\n                                    </table>\r\n                                  </td>\r\n                                </tr>\r\n                                <tr>\r\n                                  <td class=\"C-Field\">Ketik Ulang PIN Anda <span class=\"asterish\">*</span></td>\r\n                                  <td class=\"C-Field\">:</td>\r\n                                  <td class=\"C-Field\">\r\n                                    <input\r\n                                class=boxdefault size=25 name=ulang_pin type=\"text\" value=" + String.valueOf((String)session.getAttribute("pin"))+ ">\r\n                                  </td>\r\n                                </tr>\r\n                                <tr>\r\n                                  <td class=\"C-Field\">Nomor Otorisasi <span class=\"asterish\">**</span></td>\r\n                                  <td class=\"C-Field\"> :</td>\r\n                                  <td class=\"C-Field\">\r\n                                    <input\r\n         ");
                out.print("</div>\r\n                                        </td>\r\n                                      </tr>\r\n                                    </table>\r\n                                  </td>\r\n                                </tr>\r\n                                <tr>\r\n                                  <td class=\"C-Field\">Ketik Ulang PIN Anda <span class=\"asterish\">*</span></td>\r\n                                  <td class=\"C-Field\">:</td>\r\n                                  <td class=\"C-Field\">\r\n                                    <input\r\n                                class=boxdefault size=25 name=ulang_pin type=\"text\" >\r\n                                  </td>\r\n                                </tr>\r\n                                <tr>\r\n                                  <td class=\"C-Field\">Nomor Otorisasi <span class=\"asterish\">**</span></td>\r\n                                  <td class=\"C-Field\"> :</td>\r\n                                  <td class=\"C-Field\">\r\n                                    <input\r\n         ");
                out.print("                       class=boxdefault size=25 name=no_autoriz type=\"password\">\r\n                                  </td>\r\n                                </tr>\r\n                              </table>\r\n                            </td>\r\n                            <td>&nbsp;</td>\r\n                          </tr>\r\n                          <tr>\r\n                            <td height=\"1\"><img src=\"images/v_sdt_kr_btm.gif\" width=\"5\" height=\"5\"></td>\r\n                            <td><img src=\"images/dot.gif\" width=\"1\" height=\"1\" hspace=\"1\"></td>\r\n                            <td height=\"5\" width=\"5\"><img src=\"images/v_sdt_kn_btm.gif\" width=\"5\" height=\"5\"></td>\r\n                          </tr>\r\n                        </table>\r\n                      </td>\r\n                    </tr>\r\n                    <tr>\r\n                      <td height=\"35\" valign=\"top\">\r\n\t\t\t\t\t  \t\t\t\t\t        ");
                if (request.getParameter("error")!=null) //[ /Pin_Pengguna_User.jsp; Line: 165]
                { //[ /Pin_Pengguna_User.jsp; Line: 166]
                    //[ /Pin_Pengguna_User.jsp; Line: 167]
                    //[ /Pin_Pengguna_User.jsp; Line: 167]
                    out.print("\r\n        ");
                    out.print(String.valueOf(printError(errMsg(request.getParameter("error"),""))));  //[ /Pin_Pengguna_User.jsp; Line: 168]
                    out.print("\r\n        ");
                    //[ /Pin_Pengguna_User.jsp; Line: 169]
                } //[ /Pin_Pengguna_User.jsp; Line: 170]
                //[ /Pin_Pengguna_User.jsp; Line: 171]
                //[ /Pin_Pengguna_User.jsp; Line: 171]
                out.print("\r\n                        <div align=\"center\">\r\n                          <table width=\"350\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" height=\"55\">\r\n                            <tr>\r\n                              <td width=\"14\">\r\n                                <div align=\"center\"><b> </b></div>\r\n                              </td>\r\n                              <td width=\"170\">\r\n                                <div align=\"center\"><b> </b></div>\r\n                                <div align=\"center\"><b>\r\n\r\n<input class=boxstandard type=\"button\" value=\"PERIKSA\" name=\"btnperiksa\"  onClick=\"pin()\">\r\n\r\n                                  </b></div>\r\n                              </td>\r\n                              <td width=\"166\">\r\n<div align=\"center\"><b>\r\n<input class=boxstandard type=\"button\"  value=\"LOGOUT\" name=\"btnkel\" onclick=\"keluar()\">\r\n\r\n\r\n    </b></div>\r\n                              </td>\r\n                            </tr>\r\n                          </table>\r\n                        </div>");
                ...
                out.print("class=\"linkyellow\">Masukkan Nomor\r\n                              Otorisasi sesuai yang Anda terima</font></td>\r\n                          </tr>\r\n                        </table>\r\n                      </td>\r\n                    </tr>\r\n                  </table>\r\n                </td>\r\n              </tr>\r\n            </table>\r\n            </td>\r\n        </tr>\r\n      </table>\r\n    </td>\r\n  </tr>\r\n  <tr>\r\n    <td>&nbsp;</td>\r\n  </tr>\r\n</table>\r\n</form>\r\n</BODY></HTML>\r\n");
            } //[ /Pin_Pengguna_User.jsp; Line: 236]
            else //[ /Pin_Pengguna_User.jsp; Line: 237]
            { //[ /Pin_Pengguna_User.jsp; Line: 238]
                response.sendRedirect("index.jsp"); //[ /Pin_Pengguna_User.jsp; Line: 239]
            } //[ /Pin_Pengguna_User.jsp; Line: 240]
            out.print("\r\n");
