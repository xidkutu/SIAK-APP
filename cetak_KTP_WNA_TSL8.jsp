...
function showDialogBox()
{
    ...
    else
    {
      ...
      document.formktpwna.action="cetak_KTP_WNA_TSL8.jsp?flag=0&spesifik_nik="+document.formktpwna.spesifik_nik.value;
...
function checkRadioButton(flag)
{
   ...
   for (i=0;i<radio.length;i++)
  {
   ...
   {
      document.formktpwna.action="cetak_KTP_WNA_TSL8.jsp?flag=" + flag;
      document.formktpwna.submit();
   }
}
</SCRIPT>
