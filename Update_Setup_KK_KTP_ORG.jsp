...
try
   {
      ...
      if(jabatan != null && namapej != null && nippej != null)
      {
         ...
         b = remotePenan.setupKec(no_kec,no_kab,no_prop,jabatan,namapej,status,nippej);
      }
      else
      {
        jabatan=null;
      ...
      {
          b1 = remotePenan.setupKel(no_kel,no_kec,no_kab,no_prop,jabakel,namapejkel,niplur);
      }
      else
      {
        jabakel=null;
