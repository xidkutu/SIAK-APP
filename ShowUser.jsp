              ...
              <td class="C-BG">
                <table border="0" cellspacing="1" cellpadding="3" align="center">
                  <tr>
                    ...
                    <td class="C-Fonts">
                      <div align="center"><font face="Verdana, Arial, Helvetica, sans-serif" size="2" class="C-Fonts">Kode Penggunaan/User</font></div>
                    </td>
                    <td class="C-Fonts">
...
{
ne.printStackTrace();
  System.out.println("Exception in Show User = " + ne);
}
