...
function checkRadioButton(action,cursor)
{
   ...
   for (i=0;i<radio.length;i++)
  {
   ...
   top.opener.document.formbiodata.action="cetak_biodata_WNI.jsp?nama_kel=" + top.opener.document.all["nkel"].value+"&no_kel="+top.opener.document.all["no_kel"].value+"&action="+action+"&cursor=" + cursor + "&nokk=" +document.all['nokk'].value+"&nama_start=" + document.all['nama_lgkp'].value+"&max_row="+ document.all['max_row'].value;
...
{
%>
function checkRadioButton(nokk,nama)
{
...
if ((nokk!="") && (nokk!=null))
    {
//      top.opener.document.formDaftarKK.action=file+"flag=0&spesifik_kk="+nokk+"&nama_kel="+top.opener.document.all["nkel"].value;
      top.opener.document.formDaftarKK.action=file+"nama_kel="+top.opener.document.all["nkel"].value+"&no_kel="+top.opener.document.all["no_kel"].value+"&flag=0&spesifik_kk="+nokk;
      top.opener.document.formDaftarKK.submit();
    }
if ((trim(nama)!="") && (nama!=null))
    {
      top.opener.document.formDaftarKK.action=file+"flag=0&spesifik_nama="+nama+"&nama_kel="+top.opener.document.all["nkel"].value;
      top.opener.document.formDaftarKK.submit();
    }
top.window.close();
}
    ...
    <td valign="middle" align="center">
        <table width="100%" border="0" cellspacing="1" cellpadding="3" class="C-BG">
          ...
          <tr>
            ...
            <td class="C-Field">
              <input   class=boxdefault size=25 name="nokk">
            </td>
          </tr>
          <tr>
            <td class="C-Field">
          ...
          <tr>
            <td class="C-Field" colspan="2" align="center">
             ...
             <%              }
                           ...
                           {
              %>
                        <input  class=boxstandard  type="submit"  value="TAMPILKAN" onclick="checkRadioButton(document.all['nokk'].value,document.all['nama_lgkp'].value)">
               <%
                        }
             %>
            </td>
