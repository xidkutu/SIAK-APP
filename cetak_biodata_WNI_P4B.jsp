...
if(record != null)
  {
      if (request.getParameter("exit")!=null
         ...
         System.out.println(1);
            try{
              if (session.getAttribute("p4bdelg")!=null)
                 {
                  delgobj=(ListDelegate)session.getAttribute("p4bdelg");
                  delgobj.releaseMem();
                  delgobj=null;
                  session.removeAttribute("p4bdelg");
                 }
...
function checkRadioButton(action,cursor)
{
   ...
   for (i=0;i<radio.length;i++)
  {
   ...
   document.formbiodata.action="cetak_biodata_WNI_P4B.jsp?nama_kel=" + document.all["nkel"].value+"&no_kel="+document.all["no_kel"].value+"&action="+action+"&cursor=" + cursor + "&max_row=<%=MAXROW%>";
   document.formbiodata.submit();
   }
}
function releaseMem()
{
document.formbiodata.action="cetak_biodata_WNI_P4B.jsp?exit=true";
document.formbiodata.submit();
}
...
window2=openIT('adv_list_p4b.jsp',310,200,580,475,'window2',5,false,false,false);
}
</SCRIPT>
...
no_kk_spec=request.getParameter("no_kk");
...
if (action.equals("EXEC"))
   {
         ...
         try{
            ...
            }catch(Exception rlmem)
            {
              ...
              if (!no_kk_spec.trim().equals(""))
                  {
               prm.NO_KK=no_kk_spec;
                  prm.ROWS=50;
                  }
              ...
              session.setAttribute("p4bdelg",delgobj);
              counter=0;
  }
  else if (session.getAttribute("p4bdelg")!=null)
            {
            delgobj=(ListDelegate)session.getAttribute("p4bdelg");
            }
...
%>
                              ...
                              <table border="0" cellspacing="1" cellpadding="3" align="center" width="100%">
                                <tr>
                                  <td class="C-Field" colspan="2">
                                    <div align="center"><b>Cetak Biodata WNI P4B</b></div>
                                  </td>
                                </tr>
                                <tr>
   ...
   <table  border="0" cellspacing="2" cellpadding="0" align="center">
                          ...
                          <tr>
                    <td width="214" nowrap>
<a href="#"  onClick="checkRadioButton('EXEC','none')">
<font color="#2A00AA"><b>Tampilan  Semua Data</b></font>
</a>
</td>
                            <td  nowrap>
                             <a href="#" onClick="openSearchWin()"><font color="#2A00AA"><b>Pencarian Canggih</b></font></a>
                            </td>
                     </tr>
                          <tr>
                         <td colspan="2">&nbsp;
...
<%
       if(clientlist==null)
      {
        counter=0;            //Reinitialize  page counter
%>
                                <tr>
...
<input class=boxstandard type=button value=TAMPILKAN name="tampilkan" onclick="if(document.formbiodata.cb.length==undefined){viewBiodataIndividu(1);}else{viewBiodataIndividu(document.formbiodata.cb.length);}" <%if(clientlist==null){%>disabled<%}%>>
                      ...
                      <td width="101">
                        <div align="center"><b>
<input class=boxstandard type=button value=KELUAR name="keluar" onclick="releaseMem()">                          </b></div>
</td>
<td width="230" align="right">
<div id="prog" style="visibility:hidden">
<font face="Geneva, Arial, Helvetica, san-serif" size="3" color="#FFFFFF">
<i><b>Processing....</b></i>
</font>
</div>
...
if ((!no_kk_spec.trim().equals("")) || (!nik_spec.trim().equals("")))
     counter=0;
   else
      {
if (clientlist!=null)
{
%>
      <div align="right" id="idprv">
        <a name="previous" href="#1" onclick="checkRadioButton('none','prev')">
        <img src="images/left-bevelb.gif" border="0" alt="Sebelumnya" width="18" height="18"><b>&lt;&ltSebelumnya</b>
         </a> </div>
</td>
<td>

<div align="right" id="idnxt">
<a name="next" href="#2" onclick="checkRadioButton('none','next');">
