...
<FORM action="Data_KK_Input.jsp" method=post name="datakelu">
                            ...
                            <td valign="top" height="172">
                              <table width="650" border="0" cellspacing="3" cellpadding="2" align="center">
                                ...
                                class=boxdefault size=5 name=kodepos maxlength="5" onKeyUp="return num(datakelu.kodepos)">
                                  ...
                                  <td>
                                    <input
                                class=boxdefault size=20 name=telp maxlength="20" onKeyUp="return char1(datakelu.telp)">
                                  </td>
                                </tr>
                              </table>
                            </td>
                ...
                <td>
                  <table width="350" border="0" cellspacing="0" cellpadding="0" align="center" height="55">
                    <tr>
                      <td valign="bottom">
                        <div align="center"><b>
                          <input class=boxstandard type=submit value=SIMPAN KK name="button3"  onClick="return n_kap()">
                          </b></div>
                      </td>
