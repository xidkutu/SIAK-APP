...
function checkRadioButton(flag)
{
   ...
   for (i=0;i<radio.length;i++)
  {
   ...
   else
   {
      ...
      document.formktpwni.action="ktp_dki.jsp?flag=" + flag+"&nama_kel="+document.all["nkel"].value+"&no_kel="+document.all["no_kel"].value;//+"&param="+document.all["param"].value;
      document.formktpwni.submit();
   }
