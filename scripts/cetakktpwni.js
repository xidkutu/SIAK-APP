...
/*
function showDialogBox(nik,nama)
{
    ...
    if ((nik!="") && (nik!=null) && (nik.length==16) && !isNaN(nik))
    {
      ...
      document.formktpwni.action="cetak_KTP_WNI.jsp?flag=0&spesifik_nik="+document.formktpwni.spesifik_nik.value+"&nama_kel="+document.all["nkel"].value;
   ...
   var param="";
	...
	var kendali = document.formktpwni.tampilkdl;
      ...
      if(onemember)
        ...
        else if( oneimgfoto==true && document.formktpwni.member.value==1 && ( document.all["imgfoto"].src==null || document.all["imgfoto"].src=="") )
        {
            alert("Belum Pilih Foto!");
        }
        else if( oneimgfoto==true && document.formktpwni.member.value==2 && ( document.all["imgfoto0"].src==null || document.all["imgfoto0"].src=="") )
        {
            alert("Belum Pilih Foto!");
        }
        else
        {
            ...
            //alert(penandatangan)
            window.open("cetak_KTP_Lampiran.jsp?kewarganegaraan=WNI&radiobutton="+document.all['stat_print'].value+"&nama_prop="+document.all["nama_prop"].value+"&nama_kab="+document.all["nama_kab"].value+"&nama_kec="+document.all["nama_kec"].value+"&cb="+param+"&nama_kel="+document.all["nkel"].value+ "&no_kel="+document.formktpwni.no_kel.value + "&selidx=" + document.all['selidx'].value+penandatangan+"&tmpkendali="+kendaliValue, '','fullscreen=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no' );
        }
     }
     else
     {
...
function checkRadioButton(flag)
{
   ...
   for (i=0;i<radio.length;i++)
  {
   ...
   else
   {
      ...
      document.formktpwni.action="cetak_KTP_WNI.jsp?flag=" + flag+"&nama_kel="+document.all["nkel"].value+"&no_kel="+document.all["no_kel"].value;
      document.formktpwni.submit();
   }
}
...
document.all['start'].value=0;document.all['end'].value=0;
document.all['tot_rec'].value=0;document.all['page_no'].value=0;
