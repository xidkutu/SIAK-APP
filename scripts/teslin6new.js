...
{
if(len==8 && document.all["member"].value=="2")
{
...
else if(len!=8 &&document.all["member"].value=="2")
{
/*      if( !document.formktpwni.cb[len].checked && (document.all["imgfoto"+len].src!= null
               || document.all["imgfoto"+len].src!="") )*/
if( !document.formktpwni.cb.checked && (document.all["imgfoto"+len].src!= null
               || document.all["imgfoto"+len].src!="") )
      {
          document.all["imgfoto"+len].src="";
...
document.all['param'].value="";
 ...
 while(true)
    ...
    if ((nik!="") && (nik!=null) && (nik.length==16) && !isNaN(nik))
    {
      ...
      document.formktpwni.action="teslin_6.jsp?flag=0&spesifik_nik="+document.formktpwni.spesifik_nik.value+"&nama_kel="+document.all["nkel"].value;
...
function setDocs(v) {
    ...
    else if(document.formktpwni.cb==undefined)
    {
        ...
        {
        niks = document.formktpwni.cb.value+"|"+document.all["imgfoto"].src+"|"+document.all["imgperson"+indexFoto].src;
        }
    }
    else
    {
...
{
 alert("Nama Kelurahan belum dipilih !!");
 document.all['nama_kel'].focus();
return false;
}
*/
document.all['nkel'].value=document.all['nama_kel'].options[document.all['nama_kel'].selectedIndex].text;
    var niks="";
    var arr = new Array(v);
    var x = 0;
    var chk=false;
    ...
    if(v>1)
    {
     ...
     for(i=0;i<v;i++)
     {
        if(document.formktpwni.cb[i].checked)
        {
           niks=document.formktpwni.cb[i].value;
           indexFoto = i;
           //Edited by Request - Cetak KTP jadi berbelit-belit
		   if(document.all["imgfoto"+indexFoto].src!=null && document.all["imgfoto"+indexFoto].src!="" &&
           ...
           else
           {
			   ...
			   var imgfotokosong = "";
			   var imgpersonkosong = "";
               arr[x] = niks+"|"+imgfotokosong+"|"+imgpersonkosong;
               //return;
           }
           x++;
           chk=true;
	...
	var kendali = document.formktpwni.tampilkdl;
      ...
      if( oneimgfoto==false)
...

        {
            ...
            //alert(penandatangan)
            //window.open("teslin_6_lampiran.jsp?kewarganegaraan=WNI&radiobutton="+document.all['stat_print'].value+"&nama_prop="+document.all["nama_prop"].value+"&nama_kab="+document.all["nama_kab"].value+"&nama_kec="+document.all["nama_kec"].value+"&cb="+document.all["param"].value+"&imgdokumen="+document.all["imgdokumen"].src+"&nama_kel="+document.all["nkel"].value+ "&no_kel="+document.formktpwni.no_kel.value + "&selidx=" + document.all['selidx'].value+penandatangan+"&tmpkendali="+kendaliValue, '','fullscreen=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no');
//	    window.open("teslin_6_lampiran.jsp?kewarganegaraan=WNI&radiobutton="+document.all['stat_print'].value+"&nama_prop="+document.all["nama_prop"].value+"&nama_kab="+document.all["nama_kab"].value+"&nama_kec="+document.all["nama_kec"].value+"&cb="+document.all["param"].value+"&imgdokumen="+document.all["hidfilepath"].value+"&nama_kel="+document.all["nkel"].value+ "&no_kel="+document.formktpwni.no_kel.value + "&selidx=" + document.all['selidx'].value+penandatangan+"&tmpkendali="+kendaliValue, '','fullscreen=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no');
	    window.open("teslin_6_lampiran.jsp?kewarganegaraan=WNI&radiobutton="+document.all['stat_print'].value+"&nama_prop="+document.all["nama_prop"].value+"&nama_kab="+document.all["nama_kab"].value+"&nama_kec="+document.all["nama_kec"].value+"&no_prop="+document.all["no_prop"].value+"&no_kab="+document.all["no_kab"].value+"&no_kec="+document.all["no_kec"].value+"&cb="+document.all["param"].value+"&imgdokumen="+document.all["hidfilepath"].value+"&nama_kel="+document.all["nkel"].value+ "&no_kel="+document.formktpwni.no_kel.value + "&selidx=" + document.all['selidx'].value+penandatangan+"&tmpkendali="+kendaliValue, '','fullscreen=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no');
        }
     }
     else
     {
...
function checkRadioButton(flag)
{
   ...
   for (i=0;i<radio.length;i++)
  {
   ...
   else
   {
      ...
      document.formktpwni.action="teslin_6.jsp?flag=" + flag+"&nama_kel="+document.all["nkel"].value+"&no_kel="+document.all["no_kel"].value;//+"&param="+document.all["param"].value;
      document.formktpwni.submit();
   }
...
function back(flag)
{
  ...
  {
      if(document.formktpwni.cb==undefined){setDocs(1);}else{setDocs(document.formktpwni.cb.length);}
      document.all["start"].value = document.all["start"].value - 8;
      document.all["end"].value = document.all["end"].value - 8;
      document.formktpwni.action="teslin_6.jsp?flag=" + flag+"&nama_kel="+document.all["nkel"].value+"&no_kel="+document.all["no_kel"].value;//+"&param="+document.all["param"].value;
      document.formktpwni.submit();
   }
}
