function kab()
{
/*	if(form1.nik_sksi12.value == "")
	{
		alert("NIK Saksi-I belum diisi !")
		tp1.setSelectedIndex(4)
		form1.nik_sksi12.focus()
		return false
	}
       if(form1.nik_sksi12.value.length != 16 && form1.nik_sksi12.value.substring(0,1) != 'A')
	{
	...
	if(form1.nik_sksi12.value.substring(0,1) == 'A' && form1.nik_sksi12.value.length != 17)
	{
	...
	if(form1.nik_sksi23.value == "")
	{
		alert("NIK Saksi-II belum diisi !")
		tp1.setSelectedIndex(5)
		form1.nik_sksi23.focus()
		return false
	}
       if(form1.nik_sksi23.value.length != 16 && form1.nik_sksi23.value.substring(0,1) != 'A')
	{
		alert("Pengisian NIK 16 digit !")
		tp1.setSelectedIndex(5)
		form1.nik_sksi23.focus()
	...
	if(form1.nik_sksi23.value.substring(0,1) == 'A' && form1.nik_sksi23.value.length != 17)
	{
		alert("Pengisian NIK 17 digit !")
		tp1.setSelectedIndex(5)
		form1.nik_sksi23.focus()
	...
	{
		alert("Jenis Daftar Kelahiran belum diisi !.")
	...
	{
		alert("Dasar Hukum Pencatatan Kelahiran belum diisi !.")
		tp1.setSelectedIndex(6)
		form1.dsrhk_cttlhr.focus()
		return false
	}

	if(form1.doc_per.value == "")
	{
