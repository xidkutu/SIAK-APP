     ...
     if(chk)
     {
      ...
      if( oneimgfoto==false)
...

        {
            ...
            //alert(penandatangan)
            window.open("teslin_6_lampiran.jsp?kewarganegaraan=WNI&radiobutton="+document.all['stat_print'].value+"&nama_prop="+document.all["nama_prop"].value+"&nama_kab="+document.all["nama_kab"].value+"&nama_kec="+document.all["nama_kec"].value+"&cb="+document.all["param"].value+"&imgdokumen="+document.all["imgdokumen"].src+"&nama_kel="+document.all["nkel"].value+ "&no_kel="+document.formktpwni.no_kel.value + "&selidx=" + document.all['selidx'].value+penandatangan, '','fullscreen=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no');
        }
     }
     else
     {
