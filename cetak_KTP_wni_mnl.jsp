...
window2=openIT('adv_list.jsp?r=h&type=1',310,140,580,475,'window2',5,false,false,false);
}
</SCRIPT>
<SCRIPT language=JavaScript src="scripts/trim.js"></SCRIPT>
<SCRIPT language=JavaScript src="scripts/newwilayah2.js"></SCRIPT>
<SCRIPT language=JavaScript src="scripts/ktpwnimnl.js"></SCRIPT>
<%
...
System.out.println("Jenis Pencetakan : "+ stat_print);
...
tot_page=(long)(Math.ceil((double)tot_rec/6));
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
               <td background="images/v_bg_header.gif">
                  <input type="hidden" name="param" value='<%=((request.getParameter("param")==null)?"":request.getParameter("param"))%>'>
            ...
            <tr>
               <td>
<div align="center"><span class="submenu">Daftar Cetak Kartu Tanda Penduduk (KTP)</span></div>
<br>
                                                      ...
                                                      <table border="0" cellspacing="1" cellpadding="3" align="center" width="100%">
                                                         ...
                                                         <tr>
                                                            <td class="C-Field" width="27%">
                                                               <div align="center"><input type="radio" name="radiobutton" value="Baru" <%=brchk%>> Baru</div>
                                                            </td>
                                                            <td class="C-Field" width="40%">
                                                               <div align="center"> <input type="radio" name="radiobutton" value="Penggantian" <%=perchk%>> Penggantian</div>
                                                            </td>
                                                            <td class="C-Field" width="33%">
                                                               <div align="left"><input type="radio" name="radiobutton" value="Perpanjangan" <%=ulgchk%>> Perpanjangan</div>
                                                            </td>
                                                         </tr>
                                                      </table>
                                                   </td>
...
%>
                                 ...
                                 <td width="104">
                                    <div align="center"><b><input class=boxstandard type=button value=TAMPILKAN   name="tampilkan" onClick="if(document.formktpwni.cb.length==undefined){viewKTP_WNIPage(1);}else{viewKTP_WNIPage(document.formktpwni.cb.length);}"
<%if( (vKtp.size()==0 && wniObject==null)|| (wniObject!=null && wniObject.getFound()==false) ){%>disabled<%}%>></b></div>
                                 </td>
                                 <td width="101">
...
<%}%>
   ...
   <%if (!nama_one && !nik_one && (vKtp.size()!=0) && (radiobutton!=null) && (!radiobutton.trim().equals("")))
       ...
       %>
         ...
         <input type=hidden name="nkel" <%if(nama_kel!=null && !nama_kel.trim().equals("")){%>value="<%=nama_kel%>"<%}%>>&nbsp;</td>
         <script language="javascript">
            function bottom()
            {
               window.scroll(0,800);
