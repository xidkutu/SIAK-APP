<%@page import="java.util.*,java.text.*, pendaftaran.*,com.siak.validate.*"%>
...
if(record != null)
{
       ...
       //delevel=request.getParameter("level");
                      ...
                      <td height="45" valign="top">
                        ...
                        <div align="center"><b> </b>
						    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
							    <td align="center">
								<% if (screen_code.trim().equals("26")) { %>
                                  <input type="checkbox" name="cetakpdf" value="pdf">
							Cetak PDF<br>
							<input type="checkbox" disabled name="cetakxls" value="xls">
							Cetak XLS
							<% } %>
							</td>
						  </tr>
...
var ncetakxls="";
<% if (screen_code.trim().equals("26")) { %>
if(pilwil.cetakpdf.checked==true) {
 ncetakpdf="pdf";
} else {
 ncetakpdf="";
}
if(pilwil.cetakxls.checked==true) {
 ncetakxls="xls";
} else {
 ncetakxls="";
}
...
{
%>
var another=window.open("<%=request.getParameter("prefix").trim()%>"+pilwil.nprop.value+pilwil.nkab.value+pilwil.nkec.value+pilwil.nkel.value+".pdf",'','fullscreen=no,scrollbars=yes,resizable=yes,menubar=yes,toolbar=yes');
