...
System.out.println("sysdate di dependenci_ratio.jsp: "+sysdate);
%>
                ...
                <td>
                  <table width="480" border="0" cellspacing="3" cellpadding="0" align="center">
                    <tr>
                      <td height="1">
                        <div
align="center"><img src="images/batas_dot.gif" width="461" height="1"></div>
                      </td>
                    </tr>
                    <tr>
                      <td height="25">
                        <div
align="center"><span class="subtitle">Struktur Umur dan Angka Beban<br>
...
align="center"><img src="images/batas_dot.gif" width="461" height="1"></div>
                    ...
                    <tr>
                      <td
height="10"><img src="images/dot.gif" width="1" height="10"></td>
                    </tr>
                  <tr>
                      ...
                      <td>
                        <table width="442" border="0" cellspacing="3" cellpadding="0" align="center">
                          <tr>
                            ...
                            <b><%=sysdate.trim().toUpperCase()%></b>
<input type="hidden" value=<%=sysdate.trim().toUpperCase()%> name=dat>
                          </tr>
                        </table>
                      </td>
                    </tr>
...
<input class=boxstandard type=button onClick="javascript:history.back()" value=KELUAR name="submit222">
...
function dat()
{
window.open("Dependenci_Ratio_Tamp.jsp?sysdate=<%=sysdate.trim().toUpperCase()%>",'','fullscreen=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no');
}
</SCRIPT>
</HTML>
<%}
