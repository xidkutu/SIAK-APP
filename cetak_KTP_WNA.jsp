...
function showDialogBox()
{
    ...
    else
    {
      ...
      document.formktpwna.action="cetak_KTP_WNA.jsp?flag=0&spesifik_nik="+document.formktpwna.spesifik_nik.value;
...
function viewKTP_WNAPage(v)
{
    ...
    if(v>1)
    {
     for(i=0;i<v;i++)
     {
        if(document.formktpwna.cb[i].checked)
        {
           ...
           {
               alert("Belum Pilih Foto ke "+indexFoto+"!");
               return;
           }
           x++;
           chk=true;
    ...
    else if(document.formktpwna.cb.length==undefined)
    {
        ...
        {
        niks = document.formktpwna.cb.value+"|"+document.all["imgfoto"+indexFoto].src;
        }
        else if(document.formktpwna.member.value==1)
        {
        niks = document.formktpwna.cb.value+"|"+document.all["imgfoto"].src;
        }
    ...
    else
    {
     ...
     if(chk)
     {
        ...
        if( oneimgfoto==false && ( document.all["imgfoto"+indexFoto].src==null || document.all["imgfoto"+indexFoto].src=="") )
        {
            alert("Belum Pilih Foto!");
        }
        else if( oneimgfoto==true && document.formktpwna.member.value==1 && ( document.all["imgfoto"].src==null || document.all["imgfoto"].src=="") )
        {
            alert("Belum Pilih Foto!");
        }
        else if( oneimgfoto==true && document.formktpwna.member.value==2 && ( document.all["imgfoto0"].src==null || document.all["imgfoto0"].src=="") )
        {
            alert("Belum Pilih Foto!");
        }
        else
        {
               window.open("cetak_KTP_Lampiran_WNA.jsp?kewarganegaraan=WNA&radiobutton="+radioValue+"&nama_prop="+document.all["nama_prop"].value+"&nama_kab="+document.all["nama_kab"].value+"&cb="+param+"&nama_pej="+document.all["nama_pej"].value+"&nip_pej="+document.all["nip_pej"].value+"&a_n="+document.all["a_n"].value, '','fullscreen=yes,scrollbars=yes,resizable=yes,menubar=no,toolbar=no' );
        }
     }
     else
     {
...
function checkRadioButton(flag)
{
   ...
   for (i=0;i<radio.length;i++)
  {
   ...
   {
      document.formktpwna.action="cetak_KTP_WNA.jsp?flag=" + flag;
      document.formktpwna.submit();
   }
}
</SCRIPT>
...
catch(Exception e)
{
    ...
    System.out.println("#ServiceController Error= "+e.toString());
                  ...
                  <td height="1" width="5"><img src="images/v_sdt_kr_btm.gif" width="5" height="5"></td>

                  <td height="1" width="973"><img src="images/dot.gif" width="1" height="1" hspace="1"></td>

                  <td width="10" height="1"><img src="images/v_sdt_kn_btm.gif" width="5" height="5"></td>
                              </tr>
                           </table>
                        </td>
                     </tr>
